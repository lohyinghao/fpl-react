const getPlayersGWUrl = (playerId) => fetch(`https://fantasy.premierleague.com/api/entry/${playerId}/history/`);
const getPlayerUrl = (playerId) => fetch(`https://fantasy.premierleague.com/api/entry/${playerId}/`);
